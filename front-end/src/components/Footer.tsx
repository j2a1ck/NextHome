...
const Footer = () => {
  return (
    <footer className="mx-[10px] mt-10 flex h-[245px] justify-center text-right">
      <div>
        <div className="flex flex-col lg:flex-row">
          ...
          <ul className="mx-16 sm:mx-8 flex my-8 flex-col gap-2">
          ...
          <ul className="mx-16 flex sm:mx-8 my-8 flex-col gap-2">
          ...
          <ul className="mx-16 lg:mx-20 sm:mx-8 my-8 flex flex-col gap-2">
          ...
          <Image
            ...
            width={110}
            height={50}
            className="order-first m-auto  lg:m-auto h-[100px] w-[100px] lg:order-last"
          />
        </div>
      </div>
    </footer>
